 ...
 */
abstract class Delete extends ActiveCampaign implements MappableContract
{
    use Mappable;
     ...
     */
    protected function delete(string $resource, array $data): Response
    {
        return $this->client->delete(url: $resource, data: $data)
